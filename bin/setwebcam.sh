...
v4l2-ctl -d /dev/video2 --set-ctrl=saturation=160
...
v4l2-ctl -d /dev/video2 --set-ctrl=gain=70
v4l2-ctl -d /dev/video2 --set-ctrl=exposure_auto=1
v4l2-ctl -d /dev/video2 --set-ctrl=exposure_absolute=620
...
v4l2-ctl -d /dev/video2 --set-ctrl=white_balance_temperature=4200
